...
-- Dwujęzyczna aktualizacja pakietu wolnamata-events-2026-import.sql.
-- Konwencja kart: zawsze Polski / English.
-- Opis jest jednym tekstem: najpierw pełny akapit polski, następnie pełny akapit angielski.

UPDATE events AS e
SET title = v.title_bilingual,
    description = v.description_bilingual
FROM (VALUES
  ('combat-camp-sierpien-2026', 'Combat Camp Sierpień 2026 / Combat Camp August 2026', E'Czterodniowy obóz sparingowo-mentalny z trzema sesjami treningowymi dziennie. Szczegóły programu i dostępności miejsc znajdują się na stronie organizatora.\n\nA four-day sparring and mental-performance camp with three training sessions per day. Programme details and availability are provided on the organiser’s website.'),
  ('rio-fit-and-chill-camp-2026', 'Rio Fit & Chill Camp 2026 / Rio Fit & Chill Camp 2026', E'Weekendowy obóz sportowo-rekreacyjny organizowany przez Rio Grappling Club Częstochowa. Program łączy aktywność fizyczną, samoobronę i regenerację.\n\nA weekend sports and recreation camp organised by Rio Grappling Club Częstochowa, combining physical activity, self-defence and recovery.'),
  ('bt-camp-berserkers-team-2026', 'BT Camp – Obóz Berserkers Team 2026 / BT Camp – Berserkers Team Camp 2026', E'Tygodniowy obóz sportów walki z treningami BJJ, submission fighting, zapasów, MMA i muay thai. Organizator przewiduje trzy treningi dziennie oraz osobny program dla dzieci.\n\nA week-long martial arts camp featuring BJJ, submission fighting, wrestling, MMA and Muay Thai, with three daily sessions and a separate children’s programme.'),
  ('mocni-zawodnicy-2-camp-bjj-2026', 'Mocni Zawodnicy 2 – Camp BJJ / Strong Competitors 2 – BJJ Camp', E'Obóz BJJ i grapplingu nad Jeziorem Żywieckim, obejmujący treningi, seminarium BJJ Gi z Bartoszem Zawadzkim oraz dodatkowe aktywności integracyjne.\n\nA BJJ and grappling camp by Lake Żywieckie, including training, a Gi seminar with Bartosz Zawadzki and additional group activities.'),
  ('bjj-globetrotters-zen-camp-2026', 'BJJ Globetrotters Zen Camp 2026 / BJJ Globetrotters Zen Camp 2026', E'Sześciodniowy międzynarodowy obóz BJJ Gi i No-Gi z zajęciami, open matami, jogą i warsztatami. Według strony organizatora miejsca są wyprzedane.\n\nA six-day international Gi and No-Gi BJJ camp with classes, open mats, yoga and workshops. The organiser currently lists the camp as sold out.'),
  ('ffion-davies-open-no-gi-seminar-warsaw-2026', 'Otwarte seminarium No-Gi z Ffion Davies / Ffion Davies Open No-Gi Seminar', E'Otwarte seminarium No-Gi z mistrzynią świata IBJJF i ADCC, przeznaczone dla uczestników niezależnie od poziomu zaawansowania.\n\nAn open No-Gi seminar with the IBJJF and ADCC world champion, suitable for participants of every experience level.'),
  ('seminarium-zasad-ibjjf-lukasz-winiarski-2026', 'Seminarium z zasad IBJJF / IBJJF Rules Seminar', E'Otwarte szkolenie z zasad IBJJF prowadzone przez Łukasza Winiarskiego przed XXIV Pucharem Polski BJJ. Dalsze szczegóły mają zostać ogłoszone.\n\nAn open IBJJF rules seminar led by Łukasz Winiarski ahead of the 24th Polish BJJ Cup. Further details are yet to be announced.'),
  ('solt-18-mistrzostwa-polski-2026-no-gi', 'SOLT 18 x DZIK: Mistrzostwa Polski No-Gi / SOLT 18 x DZIK: Polish No-Gi Championship', E'Mistrzostwa Polski w formule No-Gi organizowane w ramach Sub Only League. Kategorie, regulamin i terminy rejestracji znajdują się na stronie wydarzenia.\n\nThe Polish No-Gi Championship held as part of the Sub Only League. Divisions, rules and registration dates are available on the event page.'),
  ('adcc-amateur-world-championship-2026', 'Amatorskie Mistrzostwa Świata ADCC 2026 / ADCC Amateur World Championship 2026', E'Amatorskie mistrzostwa świata ADCC odbywające się dzień przed głównymi mistrzostwami ADCC w Krakowie.\n\nThe ADCC Amateur World Championship, held one day before the main ADCC championship in Kraków.'),
  ('adcc-world-championship-2026-krakow', 'Mistrzostwa Świata ADCC 2026 / ADCC World Championship 2026', E'Mistrzostwa świata ADCC w submission grapplingu, po raz pierwszy organizowane w Polsce.\n\nThe ADCC Submission Fighting World Championship, hosted in Poland for the first time.'),
  ('project-roll-jiu-jitsu-7', 'Project Roll Jiu-Jitsu 7 / Project Roll Jiu-Jitsu 7', E'Turniej BJJ Gi i No-Gi dla dzieci i dorosłych. Szczegóły kategorii i rejestracji znajdują się na stronie wydarzenia.\n\nA Gi and No-Gi BJJ tournament for children and adults. Division and registration details are available on the event page.'),
  ('xxiv-puchar-polski-bjj', 'XXIV Puchar Polski BJJ / 24th Polish BJJ Cup', E'Dwudniowy Puchar Polski w brazylijskim jiu-jitsu rozgrywany według zasad IBJJF.\n\nA two-day Polish Brazilian Jiu-Jitsu Cup contested under IBJJF rules.'),
  ('iii-otwarte-mistrzostwa-dolnego-slaska-bjj-2026', 'III Otwarte Mistrzostwa Dolnego Śląska BJJ / 3rd Lower Silesia BJJ Open', E'Otwarte zawody BJJ w formułach Gi i No-Gi.\n\nAn open BJJ competition featuring Gi and No-Gi divisions.'),
  ('ogolnopolska-liga-ju-jitsu-katowice-2026-09', 'Ogólnopolska Liga Ju-Jitsu / Polish National Ju-Jitsu League', E'Zawody dla dzieci, młodzieży i dorosłych obejmujące między innymi BJJ Gi, BJJ No-Gi oraz ne-waza.\n\nA competition for children, youth and adults, including BJJ Gi, BJJ No-Gi and ne-waza divisions.'),
  ('xvi-puchar-polski-no-gi-jiu-jitsu-2026', 'XVI Puchar Polski No-Gi Jiu-Jitsu / 16th Polish No-Gi Jiu-Jitsu Cup', E'Puchar Polski No-Gi Jiu-Jitsu. Aktualne kategorie, opłaty i harmonogram znajdują się na stronie wydarzenia.\n\nThe Polish No-Gi Jiu-Jitsu Cup. Current divisions, fees and schedule are available on the event page.'),
  ...
  ('copa-14-gi-nogi', 'COPA 14 – Gi i No-Gi / COPA 14 – Gi & No-Gi', E'Turniej BJJ w formułach Gi i No-Gi.\n\nA BJJ tournament featuring Gi and No-Gi divisions.'),
  ('puchar-polski-grappling-kamien-pomorski-2026', 'Puchar Polski w Grapplingu 2026 / Polish Grappling Cup 2026', E'Puchar Polski w grapplingu dla kategorii dziecięcych, młodzieżowych i seniorskich.\n\nThe Polish Grappling Cup for children, youth and senior divisions.'),
  ...
  ('iii-bjj-colored-belts-championships', 'III Mistrzostwa BJJ Kolorowych Pasów / 3rd BJJ Colored Belts Championship', E'Turniej BJJ Gi i No-Gi dla kolorowych pasów.\n\nA Gi and No-Gi BJJ tournament for coloured belts.'),
  ('fall-open-2026', 'Jesienny Open 2026 Gi i No-Gi / Fall Open 2026 Gi & No-Gi', E'Turniej BJJ Gi i No-Gi.\n\nA Gi and No-Gi BJJ tournament.'),
  ('jelcz-laskowice-cup-iv', 'Jelcz-Laskowice Cup IV – Dolnośląska Liga BJJ / Jelcz-Laskowice Cup IV – Lower Silesia BJJ League', E'Turniej BJJ Gi i No-Gi.\n\nA Gi and No-Gi BJJ tournament.'),
  ('malopolska-liga-salt-cup-2026', 'Małopolska Liga Jiu-Jitsu – Salt Cup / Lesser Poland Jiu-Jitsu League – Salt Cup', E'Turniej BJJ Gi i No-Gi.\n\nA Gi and No-Gi BJJ tournament.'),
  ('solt-19-dzik-gi-nogi', 'SOLT 19 x DZIK: Gi i No-Gi / SOLT 19 x DZIK: Gi & No-Gi', E'Turniej Sub Only League w formułach Gi i No-Gi.\n\nA Sub Only League tournament featuring Gi and No-Gi divisions.'),
  ('malopolska-liga-cracow-cup-2026', 'Małopolska Liga Jiu-Jitsu – Cracow Cup / Lesser Poland Jiu-Jitsu League – Cracow Cup', E'Turniej BJJ Gi i No-Gi.\n\nA Gi and No-Gi BJJ tournament.'),
  ('ground-game-cup-9-2026', 'Ground Game Cup 9 – Mistrzostwa Bałtyku i Europy Wschodniej / Ground Game Cup 9 – Baltic & Eastern Europe Championship', E'Turniej BJJ Gi i No-Gi w nowym terminie wskazanym przez organizatora.\n\nA Gi and No-Gi BJJ tournament held on the organiser’s revised date.'),
  ('ii-otwarty-puchar-dolnego-slaska-bjj-2026', 'II Otwarty Puchar Dolnego Śląska BJJ / 2nd Lower Silesia BJJ Open Cup', E'Otwarty turniej BJJ Gi i No-Gi.\n\nAn open Gi and No-Gi BJJ tournament.'),
  ...
  ('adcc-polish-cup-2026', 'Puchar Polski ADCC 2026 / ADCC Polish Cup 2026', E'Puchar Polski rozgrywany według zasad ADCC.\n\nThe Polish Cup contested under ADCC rules.'),
